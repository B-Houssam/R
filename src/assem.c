...
//Définition de la taill max de la TS
#define TAILLE 100

//Définition d'un element de la TS
typedef struct elt{
	char* IDF;
	int type;
	int nature;
...
//Définition de la taille max des quads
#define TailleQuad 200

//Définition d'un quad
typedef struct {
	char* opr;
	char* op1;
	char* op2;
...
//the main fuction pour generer le code assembleur
void codeAssem(){
	int jumps[QC+1];
